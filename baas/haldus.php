...
<form action="kaubahaldus.php">
    ...
    <table>
        <tr>
            <th>Haldus</th>
            <th><a href="haldus.php?sort=nimetus">Nimetus</a></th>
            <th><a href="haldus.php?sort=grupinimi">Kaubagrupp</a></th>
            <th><a href="haldus.php?sort=hind">Hind</a></th>
        </tr>
        <?php foreach($kaubad as $kaup): ?>
            <tr>
                <?php if(isset($_REQUEST["muutmisid"]) &&
                    intval($_REQUEST["muutmisid"])==$kaup->id): ?>  <td>
                    <input type="submit" name="muutmine" value="Muuda" />  <input type="submit" name="katkestus" value="Katkesta" />  
